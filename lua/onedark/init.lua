...
function M.setup()
	...
	vim.api.nvim_command(string.format("hi EndOfBuffer guifg=%s guibg=%s",c.grey ,"none"))
	vim.api.nvim_command(string.format("hi LineNr guifg=%s",c.grey ))
	vim.api.nvim_command(string.format("hi ErrorMsg guifg=%s guibg=%s",c.red,"none" ))
